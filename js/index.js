$(function(){
    ...
    var musicNameData = ['棉','花海','晴天'];                   // 歌曲名数组
    var artistNameData = ['董又霖','周杰伦','周杰伦']            // 创作歌手数组
    var musicUrls=['music/棉-董又霖.mp3','music/花海-周杰伦.mp3','music/晴天-周杰伦.mp3'];// 歌曲mp3数组
    ...
    function playPause(){
        if(audio.paused){
            ...
            // 修改css样式名称
            playPauseBtn.attr('class','btns play-pause icon-zanting iconfont') // 显示暂停图标
            ...
            // 修改css样式名称
            playPauseBtn.attr('class','btns play-pause icon-jiediankaishi iconfont'); // 显示播放按钮
    ...
    function selectTrack(flag){
        ...
        if( flag == 0 ){
            // 修改css样式名称
            playPauseBtn.attr('class','btns play-pause icon-jiediankaishi iconfont'); // 显示播放图标
        }else{
